...
#define EU_ARNG RALT(KC_W)   // Å
#define EU_ADIA RALT(KC_A)   // Ä
#define EU_ODIA RALT(KC_O)   // Ö
...
[_MAC] = LAYOUT_75_ansi(
    ...
    KC_MEH,     HM_A,      HM_S,        HM_D,      HM_F,       KC_G,        KC_H,      HM_J,       HM_K,        HM_L,      EU_ODIA,    EU_ADIA,                             KC_ENT,     KC_PGUP,
    KC_LSFT,               KC_Z,        KC_X,      KC_C,       KC_V,        KC_B,      KC_N,       KC_M,        KC_COMM,   KC_DOT,     KC_SLSH,                 KC_RSFT,    KC_UP,      KC_PGDN,
    KC_LCTL,    KC_LALT,   KC_LGUI,                                         LT(_EURKEY, KC_SPC),                KC_RALT,   MO(1),      KC_RCTL,                 KC_LEFT,    KC_DOWN,    KC_RGHT),
...
[_WIN] = LAYOUT_75_ansi(
    ...
    KC_GRV,     KC_1,      KC_2,        KC_3,      KC_4,       KC_5,        KC_6,      KC_7,       KC_8,        KC_9,      KC_0,       KC_MINS,    KC_EQL,                  KC_BSPC,    KC_HOME,
    KC_TAB,     KC_Q,      KC_W,        KC_E,      KC_R,       KC_T,        KC_Y,      KC_U,       KC_I,        KC_O,      KC_P,       EU_ARNG,    KC_QUOT,                 KC_BSLS,    KC_END,
    KC_MEH,     KC_A,      KC_S,        KC_D,      KC_F,       KC_G,        KC_H,      KC_J,       KC_K,        KC_L,      EU_ODIA,    EU_ADIA,                             KC_ENT,     KC_PGUP,
    KC_LSFT,               KC_Z,        KC_X,      KC_C,       KC_V,        KC_B,      KC_N,       KC_M,        KC_COMM,   KC_DOT,     KC_SLSH,                 KC_RSFT,    KC_UP,      KC_PGDN,
    KC_LCTL,    KC_LALT,   KC_LGUI,                                         LT(_EURKEY, KC_SPC),                KC_RALT,   MO(3),      KC_RCTL,                 KC_LEFT,    KC_DOWN,    KC_RGHT),
